 ...
 */
public class RenderPlayerFireballSmall extends Render {

    private static final ResourceLocation fireballTexture = new ResourceLocation("textures/items/player_fireball_small.png");

    public RenderPlayerFireballSmall(RenderManager renderManager) {

        super(renderManager);
    }

    protected ResourceLocation getEntityTexture(EntityPlayerFireballSmall fireball) {
        return fireballTexture;
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity){
        return getEntityTexture((EntityPlayerFireballSmall)entity);
    }

    @Override
    public void doRender(Entity entity, double transX, double transY, double transZ, float param5, float dir){
        doRender((EntityPlayerFireballSmall) entity, transX, transY, transZ, param5, dir);
    }

    public void doRender(EntityPlayerFireballSmall fireball, double transX, double transY, double transZ, float param5, float dir){
